...
wd <- "~/AllNGSscriptsFromBennabiEtAl2024/scRNAseq"
...
# here are the sample.used for WT samples
samples.used <- c(33:56)
desiredName.for.RDS <- "combined.size"


# if you want to remove some genes from analysis, please add them in this variable
manual.removal.genes <- rownames(combined.seurat)[grepl("^Gm", rownames(combined.seurat))]
